...
import { Plus, Eye, Trash2, Search, ChevronLeft, ChevronRight } from 'lucide-react';
                  ...
                  <tr key={demande.id} className="hover:bg-muted/50 transition-colors">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm">
                      <div className="flex items-center gap-2">
                        ...
                        {canModifyStatut && demande.statut === 'EN_ATTENTE' && (
                          <Button
                            size="sm"
                            variant="outline"
        ...
        {totalPages > 1 && (
          <div className="flex items-center justify-between px-6 py-4 border-t border-border">
            <div className="text-sm text-muted-foreground">
              ...
              {Math.min(currentPage * ITEMS_PER_PAGE, filteredDemandes.length)}{' '}
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-base font-semibold">{selectedDemande.employeNom}</p>
                </div>
                <div>
                  <p className="text-sm font-medium text-muted-foreground">Matricule</p>
                  <p className="text-base font-semibold">{selectedDemande.employeMatricule}</p>
                </div>
                <div>
                  <p className="text-sm font-medium text-muted-foreground">Date de début</p>
                  <p className="text-base">
                    {format(new Date(selectedDemande.dateDebut), 'dd MMMM yyyy', { locale: fr })}
                  </p>
                </div>
                <div>
                ...
                <div>
                  <p className="text-sm font-medium text-muted-foreground">Nombre de jours</p>
                  <p className="text-base font-semibold text-primary">{selectedDemande.nombreJours} jours</p>
                </div>
                <div>
                ...
                {selectedDemande.typeConge && (
                  <div>
                    <p className="text-sm font-medium text-muted-foreground">Type de congé</p>
                ...
                <div>
                  ...
                  <p className="text-base">
                    {format(new Date(selectedDemande.dateCreation), 'dd MMMM yyyy', { locale: fr })}
                  </p>
                </div>
              </div>
              ...
              {selectedDemande.adressePendantConge && (
                <div>
                  <p className="text-sm font-medium text-muted-foreground mb-1">Adresse pendant le congé</p>
                  <p className="text-base p-3 bg-muted rounded-lg">{selectedDemande.adressePendantConge}</p>
                </div>
              )}
              
              {selectedDemande.remarque && (
                <div>
                  <p className="text-sm font-medium text-muted-foreground mb-1">Remarque</p>
                  <p className="text-base p-3 bg-muted rounded-lg">{selectedDemande.remarque}</p>
                </div>
              )}
            </div>
            <DialogFooter>
